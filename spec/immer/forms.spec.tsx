...
describe('Forms manager', () => {
    ...
    describe('on interaction with form', () => {
        it('should update checkbox value in state', () => {
            ...
            expect(StateHistory.instance.currentState['form']['condition']['new']).toBeFalsy();
        });
        ...
        it('should update radiobutton value in state', () => {
            ...
            expect(StateHistory.instance.currentState['form']['location']).toBe('usa');
        });
        ...
        it('should update multiselect value in state', () => {
            ...
            expect(StateHistory.instance.currentState['form']['cars'][0]).toBe('saab');
            expect(StateHistory.instance.currentState['form']['cars'][1]).toBe('audi');
        });
        ...
        it('should update select value in state', () => {
            ...
            expect(StateHistory.instance.currentState['form']['color']).toBe('white');
        });
        ...
        it('should update textarea value in state', () => {
            ...
            expect(StateHistory.instance.currentState['form']['description']).toBe('test');
        });
        ...
        it('should update input value in state', () => {
            ...
            expect(StateHistory.instance.currentState['form']['address']).toBe('test');
        });
        ...
        it('should update custom form element value in state', () => {
            ...
            expect(StateHistory.instance.currentState['form']['group']['complexElement']).toBe('test');
        });
    });
    ...
    it('should not update state if shouldUpdateState hook returns false', () => {
        ...
        expect(StateHistory.instance.currentState['form']['address']).toBe('Some Street 1a');
    });
});
